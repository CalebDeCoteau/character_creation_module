...
def special(char_name: str, char_class: str) -> str:
    """Значение выводит на экран применение специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит на экран описание персонажа."""
    if char_class == 'warrior':
    ...
    cmd: str = None
    while cmd != 'skip':
        """Выводит на экран результат согласно выбранного действия."""
...
def choice_char_class() -> str:
    """Выбор персонажа игры."""
    approve_choice: str = None
    char_class: str = None
    while approve_choice != 'y':
        """Даем согласие на продолжение игры."""
        char_class = input('Введи название персонажа, за которого хочешь'
                           'играть:Warrior, Mage, Healer:')
        """Описание выбра персонажа."""
        if char_class == 'warrior':
